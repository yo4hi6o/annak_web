      ...
      <dd class="col-12 col-sm-8 d-flex flex-wrap align-items-center">
        ...
        @switch($form_item->form_type)
          ...
          <div class="col-12">
            ...
            <input type="tel" name="zip{{$form_item->name}}" class="js_input_control js_zip"  id="zip{{$form_item->html_id}}id" value="{{ old("zip") }}" placeholder="{{$form_item->placeholder}}">
          </div>
          <div class="col-12 js_input_control">
            <span class="js_input_control">{{__("validation.attributes.pref")}}&nbsp;</span>
            <select name="pref{{$form_item->name}}" class="mt-1 js_pref" id="pref{{$form_item->html_id}}id">
          ...
          <div class="col-12 p-0 pl-2 mt-1 js_input_control js_address">
            <input type="text" name="address{{$form_item->name}}" value="{{ old("address") }}" class="form-control js_address" id="address{{$form_item->html_id}}id" placeholder="{{$form_item->placeholder}}">
          </div>
          @break
