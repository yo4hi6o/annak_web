    ...
    <dl class="form__block">
      ...
      <dd class="form__inputArea">
        ...
        @switch($form_item->form_type)
          ...
          <input type="text" name="address{{$form_item->name}}" class="form__input otherAddress js_input_control js_address" id="address{{$form_item->html_id}}id" value="" placeholder="{{$form_item->placeholder}}">
          @break
